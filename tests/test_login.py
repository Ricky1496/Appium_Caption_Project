...
class TestAndroidDeviceLocal(AppiumConfig):
    ...
    def test_info(self):
        ...
        self.driver.find_element(AppiumBy.ID, "com.code2lead.kwad:id/Et2").send_keys("Ricky")
        self.driver.find_element(AppiumBy.ID, "com.code2lead.kwad:id/Et3").send_keys("ricky@email.com")
        self.driver.find_element(AppiumBy.ID, "com.code2lead.kwad:id/Et6").send_keys("ricky144")
        self.driver.find_element(AppiumBy.ID, "com.code2lead.kwad:id/Et7").send_keys("98989898")
        ...
        assert_that(actual_name).is_equal_to("Name: Ricky")
        assert_that(actual_email).is_equal_to("Email: ricky@email.com")
        assert_that(actual_password).is_equal_to("Password: ricky144")
        assert_that(actual_mobile).is_equal_to("Mobile: 98989898")
